...
contract AutoBribe is Ownable {
    ...
    //PROJECT!! Double check this before changing with Kuswap
    ...
    //########################################
    //#######KUSWAP ADMIN FUNCTIONS######
    //########################################

    //Allows Kuswap to re allow project to withdraw their tokens
    ...
    // Allows project or Kuswap to reset the week to the current block
