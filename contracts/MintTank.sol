...
/**
 * @dev This contract allow the team to hold a large amount of KUS but not pre lock them.
 * It requires that KUS exiting this be locked for more than 90days.
 */
contract MintTank is Ownable {
    ...
    function mintFor(
        ...
        IKus(KUS).approve(votingEscrow, _value);
    ...
    function inCaseTokensGetStuck(
        ...
        require(_token != address(KUS), "KUS must be minted to get it out");
