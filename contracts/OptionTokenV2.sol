...
contract OptionTokenV2 is ERC20, AccessControl {
    ...
    /// @notice The voting escrow for locking KUS to veKUS
    ...
    /// @notice the discount for locking to veKUS
    ...
    /// @notice Returns the discounted price in paymentTokens for a given amount of options tokens redeemed to veKUS
    /// @param _amount The amount of options tokens to exercise
    /// @return The amount of payment tokens to pay to purchase the underlying tokens
    ...
    function _exerciseVe(
        ...
        // lock underlying tokens to veKUS
